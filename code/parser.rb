...
def parseNormalClassDeclaration
	 	puts "parseNormalClassDeclaration"
	 	parseClassModifier()
		expect :class
		expect :identifier
		parseClassBody()
...
def parseClassModifier 
		puts "parseClassModifier"
...
def parseInstanceInitializer
		puts "parseInstanceInitializer"
		parseBlock()
end


def parseStaticInitializer
		puts "parseStaticInitializer"
		expect :static
		parseBlock()
end
